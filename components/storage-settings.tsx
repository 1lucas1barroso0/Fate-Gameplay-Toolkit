    ...
    <div className="storage-settings">
      ...
      <section className="storage-action-section">
        ...
        {!activeRoom ? <p>Abra uma Mesa para medir, exportar ou excluir os dados dela no servidor. Nada é carregado em segundo plano enquanto as Mesas estão fechadas.</p> : <>
          ...
          {activeRoom.self.role === "gm" && <p className="storage-orphan-help"><b>O que significa “sem registro”?</b> É uma cópia deixada por um envio interrompido que não aparece no Histórico. A verificação não apaga arquivos publicados.</p>}
