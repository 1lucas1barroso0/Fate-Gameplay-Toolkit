...
test("incorpora integralmente os SRDs oficiais atuais e o guia editorial", () => {
  ...
  assert.equal(accelerated.chapters.filter((chapter) => chapter.mode === "full-srd").length, 11);
  assert.equal(accelerated.chapters.filter((chapter) => chapter.mode === "book-map").length, 1);
  ...
  assert.equal(venture.chapters.length, 10);
  assert.equal(venture.chapters.filter((chapter) => chapter.mode === "full-srd").length, 3);
  assert.equal(venture.chapters.filter((chapter) => chapter.mode === "book-map").length, 7);
  assert.equal(horror.chapters.length, 20);
  assert.equal(horror.chapters.filter((chapter) => chapter.mode === "full-srd").length, 8);
  ...
  assert.equal(space.chapters.length, 18);
  assert.equal(space.chapters.filter((chapter) => chapter.mode === "full-srd").length, 6);
  ...
  assert.equal(accessibilityToolkit.chapters.length, 12);
  assert.equal(accessibilityToolkit.chapters.filter((chapter) => chapter.mode === "full-srd").length, 5);
  ...
  assert.ok(accelerated.wordCountByLanguage.pt >= 11_000, "O SRD integral de Fate Acelerado em português encolheu para " + accelerated.wordCountByLanguage.pt + " palavras.");
  assert.ok(accelerated.wordCountByLanguage.en >= 11_000, "O SRD integral de Fate Acelerado em inglês encolheu para " + accelerated.wordCountByLanguage.en + " palavras.");
  ...
  assert.ok(venture.wordCountByLanguage.pt >= 20_000, "O SRD integral de Venture City em português encolheu para " + venture.wordCountByLanguage.pt + " palavras.");
  assert.ok(venture.wordCountByLanguage.en >= 20_000, "O SRD integral de Venture City em inglês encolheu para " + venture.wordCountByLanguage.en + " palavras.");
  assert.ok(horror.wordCountByLanguage.pt >= 49_000, "O SRD integral de Horror Toolkit em português encolheu para " + horror.wordCountByLanguage.pt + " palavras.");
  assert.ok(horror.wordCountByLanguage.en >= 49_000, "O SRD integral de Horror Toolkit em inglês encolheu para " + horror.wordCountByLanguage.en + " palavras.");
  ...
  assert.ok(space.wordCountByLanguage.pt >= 38_000, "O SRD integral de Fate Space Toolkit em português encolheu para " + space.wordCountByLanguage.pt + " palavras.");
  assert.ok(space.wordCountByLanguage.en >= 38_000, "O SRD integral de Fate Space Toolkit em inglês encolheu para " + space.wordCountByLanguage.en + " palavras.");
  ...
  assert.ok(accessibilityToolkit.wordCountByLanguage.pt >= 39_000, "O SRD integral de Fate Accessibility Toolkit em português encolheu para " + accessibilityToolkit.wordCountByLanguage.pt + " palavras.");
  assert.ok(accessibilityToolkit.wordCountByLanguage.en >= 39_000, "O SRD integral de Fate Accessibility Toolkit em inglês encolheu para " + accessibilityToolkit.wordCountByLanguage.en + " palavras.");
...
test("mantém busca, compartilhamento e navegação móvel em todas as fontes", async () => {
  ...
  assert.match(styles, /\.private-book-reader-dialog iframe \{[^}]*height:/);
